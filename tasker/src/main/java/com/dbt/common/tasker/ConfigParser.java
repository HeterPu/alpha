...
class ConfigParser {
    ...
    private int readMode(XmlPullParser parser) {
        ...
        if (MODE_ALL_PROCESS.equals(modeStr)) {
            return TaskerManager.ALL_PROCESS_MODE;
        } else if (MODE_MAIN_PROCESS.equals(modeStr)) {
            return TaskerManager.MAIN_PROCESS_MODE;
        } else if (MODE_SECONDARY_PROCESS.equals(modeStr)) {
            return TaskerManager.SECONDARY_PROCESS_MODE;
        } else {
            return TaskerManager.ALL_PROCESS_MODE;
        }
    }
    ...
    private static class TaskBundle {
        ...
        public int mode = TaskerManager.ALL_PROCESS_MODE;
        public String processName = "";
        public String name = "TaskerProject";
    ...
    public static class ProjectInfo {
         ...
         * {@link TaskerManager#ALL_PROCESS_MODE}<br>
         * {@link TaskerManager#MAIN_PROCESS_MODE}<br>
         * {@link TaskerManager#SECONDARY_PROCESS_MODE}<br>
         */
        public int mode = TaskerManager.ALL_PROCESS_MODE;
